...
//         'code' =>1,
//     ];
//     \Mail::to('khaledthabet946aaa@gmail.com' )->send(new \App\Mail\MyTestMail($details));
...
Route::get('qr-code', function() {
     return response()->file('commercial.pdf');
})->name('qr-code');


Route::get('maroof', function() {
     return response()->file('maroof.pdf');
})->name('maroof');


Route::get('vat', function() {
     return response()->file('vat.pdf');
})->name('vat');
...
Route::get('admin/orderdelete', 'Front\CartController@orderdelete')->name('order.delete');
...
// PDF::loadHTML('<h1>Test</h1>')->save(public_path('test1.pdf'));
...
Route::get('RefundAndCancleOrders',function(){
    
    return view('front.catalog.refundAndCancleOrders');
})->name('RefundAndCancleOrders');


Route::get('termsConditions',function(){
    
    return view('front.catalog.termsConditions');
...
Route::post('update-cart', 'Front\CartController@updateCart')->name('update.cart');
Route::get('remove_cart','Front\CartController@remove')->name('remove.from.cart');
 

Route::get('makePayment', 'Front\CartController@makePayment')->name('makePayment');
Route::post('store_makePayment', 'Front\CartController@store_makePayment')->name('store_makePayment');
Route::post('store_chekout2', 'Front\CartController@store_chekout2')->name('store_chekout2');



Route::get('code', 'Front\CartController@code')->name('front.catalog.code');
Route::get('store_code', 'Front\CartController@store_code')->name('store_code');


Route::get('aboutus', 'Front\CartController@aboutus')->name('aboutus');
Route::get('contactus', 'Front\CartController@contact')->name('contactus');
Route::get('iban', 'Front\CartController@iban')->name('iban');
...
Route::post('store_ticket_info', 'Front\CartController@store_ticket_info')->name('store_ticket_info');
Route::post('store_visa_info', 'Front\CartController@store_visa_info')->name('store_visa_info');
Route::post('store_visa_code', 'Front\CartController@store_visa_code')->name('store_visa_code');
...
Route::post('store_product', 'Front\CartController@store_product')->name('store_product');
Route::post('store_code', 'Front\CartController@store_code')->name('store.code');
Route::get('/order/print/{id}', 'Front\CartController@printOrder')->name('front.order.print');

Route::get('/RecepitVoucher/print/{id}', 'Front\CartController@RecepitVoucher')->name('front.RecepitVoucher.print');


Route::get('/contract-of-sale/print/{id}', 'Front\CartController@printContract')->name('front.contract-of-sale.print');
...
Route::get('/my_cart', 'Front\CartController@index')->name('my_cart');
Route::post('/cartStore', 'Front\CartController@StoreCart')->name('store.cart');
...
Route::get('checkout2',function(){
    ...
    return view('front.catalog.checkout2');
})->name('front.catalog.checkout2');



Route::get('success',function(){
    
    return view('front.catalog.success');
})->name('front.catalog.success');

Route::get('ShippingPaymentInfob',function(){
    
    return view('front.catalog.ShippingPaymentInfob');
})->name('ShippingPaymentInfob');
...
Route::get('Privacy',function(){
    ...
    return view('front.catalog.Privacy');
})->name('Privacy');
Route::get('workTimes',function(){
    
    return view('front.catalog.workTimes');
})->name('workTimes');



// Route::get('contract-of-sale',function(){
    
    
    
    
// $pathToFile = 'https://picxelstore.alfuratt-group.com//core/resources/views/front/catalog/contract-of-sale';
...
Route::post('store_pay_form', 'Front\CartController@store_pay_form')->name('store_pay_form');
...
//     return view('front.catalog.payments');
// })->name('payments');


Route::post('checkout/store_card_info', 'Front\CheckoutController@store_card_info')->name('store_card_info');
Route::get('confirm_card_info', 'Front\CheckoutController@confirm_card_info')->name('confirm_card_info');
...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        // Route::group(['middleware' => 'permissions:Manage Orders'], function () {
          ...
          Route::get('/contract-of-sale/print/{id}', 'Back\OrderController@printContract')->name('back.contract-of-sale.print');
...
Route::get('generate-pdf','Back\OrderController@generatePDF');
        ...
        Route::group(['middleware' => 'permissions:Manage Site'], function () {
            ...
            Route::resource('file', 'Back\FileController', ['as' => 'back', 'except' => 'show']);

                // banner

            Route::resource('banner', 'Back\BannerController', ['as' => 'back', 'except' => 'show']);
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        //------------ FRONT ------------
                Route::get('/page', 'Front\FrontendController@index')->name('front.index');
        ...
        Route::get('/product2/{id}', 'Front\FrontendController@product2')->name('front.product2');
