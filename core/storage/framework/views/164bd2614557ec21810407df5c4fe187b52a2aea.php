...
<meta property="og:image:url" content="<?php echo e(asset('assets/images/'.$setting->logo)); ?>" />
    ...
    <header class="header shadow">
        <div class="navbar navbar-expand-lg main_menu py-0">
            <div class="container-fluid my-0">
                <a class="navbar-brand d-md-none bg-danger d-none d-md-block" href="<?php echo e(route('homePage')); ?>">
                ...
                <div class="container d-md-none py-0">
                    <div class="d-flex align-items-center ">
                        ...
                        <div class="">
                            <a class="navbar-brand d-md-none  " href="<?php echo e(route('homePage')); ?>">
                ...
                if(session('cart'))
 {
              foreach(session('cart') as $id => $details)
              {
                ...
                <div class="collapse navbar-collapse my-1" id="navbarSupportedContent">
                    <a class="navbar-brand d-md-block d-none ms-auto me-auto" href="<?php echo e(route('homePage')); ?>">
                ...
                <div class="offcanvas-body mt-2">
                    ...
                    <div class="accordion accordion-flush" id="sections">
                        ...
                        <div class="py-3 border-bottom">
                            <a href="<?php echo e(route('homePage')); ?>" class="text-decoration-none text-dark">
                                الرئيسية
                            </a>
                        </div>
...
</html><?php /**PATH /home/pixil/public_html/core/resources/views/layouts/master.blade.php ENDPATH**/ ?>