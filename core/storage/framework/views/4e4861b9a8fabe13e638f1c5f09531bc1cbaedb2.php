                            ...
                            <ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
                              ...
                              <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <form  action="<?php echo e(route('back.slider.store')); ?>" method="POST"
                                ...
                                <div class="tab-pane fade" id="pills-home4" role="tabpanel" aria-labelledby="pills-home4-tab"><form  action="<?php echo e(route('back.slider.store')); ?>" method="POST"
                                    enctype="multipart/form-data">
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u131946897/domains/webook-riyadhseason.com/public_html/core/resources/views/back/slider/create.blade.php ENDPATH**/ ?>