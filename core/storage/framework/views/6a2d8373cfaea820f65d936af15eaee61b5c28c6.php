    ...
    <td>
        <div class="dropdown">
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="<?php echo e(route('back.item.edit',$data->id)); ?>"><i class="fas fa-angle-double-right"></i> تعديل</a>
              ...
              <?php else: ?>
              <a class="dropdown-item" href="<?php echo e(route('back.license.item.edit',$data->id)); ?>"><i class="fas fa-angle-double-right"></i> تعديل </a>
              <?php endif; ?>
                <?php if($data->status == 1): ?>
                <a class="dropdown-item" target="_blank" href="<?php echo e(route('front.product',$data->slug)); ?>"><i class="fas fa-angle-double-right"></i> مشاهدة المنتج</a>
              <?php endif; ?>
            
              <a class="dropdown-item" href="<?php echo e(route('back.item.highlight',$data->id)); ?>"><i class="fas fa-angle-double-right"></i>  القسم </a>
...
<?php /**PATH /home/u135631004/domains/ihtemamcommunication.store/public_html/core/resources/views/back/item/table.blade.php ENDPATH**/ ?>