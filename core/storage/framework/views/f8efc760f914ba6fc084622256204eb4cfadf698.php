...
">
  <div class="carousel-inner">
      ...
      <img class="d-block w-100" src="uploads/572811311_7Yiw2RSQoy53TD015Zh3XOCcgMYAzJr0he3gdc5C.jpg" alt="First slide">
    </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    <div class="container mt-5">
        ...
        <div class="d-flex align-items-center">
            <h5 class="text-center my-md-5 my-4 mainColor" style=""><span class="me-2">|</span>ايفون 16  </h5>
            <a  href="<?php echo e(route('front.catalog').'?category=iphone-16'); ?>" class="btn btn-outline-dark btn-sm rounded-4 ms-auto">عرض الكل</a>
        </div>
        <div class="row">
                                     
                                     
                             <?php $__currentLoopData = Item::where('category_id','72')->orderBy('id','DESC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/altajksa/public_html/core/resources/views/front/index.blade.php ENDPATH**/ ?>