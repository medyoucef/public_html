...
<section class="container mt-2 mb-3">
    <a href="categories.php-39.html?category_id=103" class="text-decoration-none text-dark">
    ...
    <div class="container mt-5">
        ...
        <div class="row">
                       ...
                       <a  href="<?php echo e(route('front.product',$item->slug)); ?>"   class="text-decoration-none">
                           <div class="product">
...
<section class="container mt-2 mb-3">
    <img src="uploads/5577528502_7Yiw2RSQoy53TD015Zh3XOCcgMYAzJr0he3gdc5C.jpg" class="w-100 rounded shadow" alt="">
        ...
        <div class="row">
                             <?php $__currentLoopData = Item::where('subcategory_id','144')->orderBy('id','DESC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     
                                     
                                      <div class="col-md-3 col-6 mb-2">
                       <a h href="<?php echo e(route('front.product',$item->slug)); ?>"   class="text-decoration-none">
                           <div class="product">
                               <img src="<?php echo e(asset('assets/images/'.$item->thumbnail)); ?>" class="w-100 " alt="ايفون 15 برو ماكس 1 تيرابايت">
                               <div class="container position-relative">
                                   <p class="productName my-0 mt-2 mb-1">     <?php echo e($item->name); ?>    </p>
...
<section class="container mt-2 mb-3">
    <img src="uploads/1050646461_1566442541_1052609418_play5.webp" class="w-100 rounded shadow" alt="">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="<?php echo e(route('front.catalog').'?category=Play-Station'); ?>" class="btn btn-outline-dark btn-sm rounded-4 ms-auto">عرض الكل</a>
        </div>
        <div class="row">
                             <?php $__currentLoopData = Item::where('category_id','58')->orderBy('id','DESC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alfuratt/ihtmam.alfuratt-group.com/core/resources/views/front/index.blade.php ENDPATH**/ ?>