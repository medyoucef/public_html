...
<link rel="stylesheet" href="https://ksapixeil.com/ajax/libs/slick-carousel/1.8.1/slick.min.css" integrity="sha512-yHknP1/AwR+yx26cB1y0cjvQUMvEa2PFzt1c9LlS4pRQ5NOTZFWbhBig+X9G9eYW/8m0/4OXNx8pxJ6z57x0dw==" crossorigin="anonymous" referrerpolicy="no-referrer">
<link rel="stylesheet" href="https://ksapixeil.com/ajax/libs/slick-carousel/1.8.1/slick-theme.css" integrity="sha512-6lLUdeQ5uheMFbWm3CP271l14RsX1xtx+J5x2yeIDkkiBpeVTNhTqijME7GgRKKi6hCqovwCoBTlRBEC20M8Mg==" crossorigin="anonymous" referrerpolicy="no-referrer">
<link rel="stylesheet" href="https://ksapixeil.com/assets/css/all.css">
<link rel="stylesheet" href="https://ksapixeil.com/assets/css/bootstrap.rtl.css">
<link rel="stylesheet" href="https://ksapixeil.com/myStyle.css"></head>
  <style>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 border rounded mt-md-0 mt-2 py-3">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="https://ksapixeil.com/#" class="text-secondary">اضف تقييمك</a>
                    </div>
                    <div class="col-6">
            ...
            <div class="col-md-4 col-12 mb-3">
                <div class="w-100">
                    ...
                    <div class="container text-center" style="font-size: 12px;">
                        <div class="mb-3">
                            <a class="text-decoration-none mainColor" href="https://ksapixeil.com/termsConditions.php.html">سياسة الضمان والاستبدال</a>
                        </div>
                        <div class="mb-3">
                            <a class="text-decoration-none mainColor" href="https://ksapixeil.com/workTimes.php.html">اوقات العمل
                            </a>
                        </div>
                        <div class="mb-3">
                            <a class="text-decoration-none mainColor" href="https://ksapixeil.com/refundAndCancleOrders.php.html">استرجاع الطلبات / الغاء الطلب / استرجاع المبالغ
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-100 text-secondary">
                    ...
                    <div class="container text-center">
                        <div class="d-flex justify-content-center">
                            <div class="me-2">
                                <img src="https://ksapixeil.com/assets/image/icons/appstore.webp" class="w-100" alt="">
                            </div>
                            <div>
                                <img src="https://ksapixeil.com/assets/image/icons/googleplay.webp" class="w-100" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="text-center mt-5">
                    <a href="https://ksapixeil.com/https://smarteco-sa.store" class="text-light p-0 border-0 text-decoration-none">
                        <img src="https://ksapixeil.com/assets/image/icons/qr-code.png" width="50" alt="">
                    </a>
                    <a href="https://ksapixeil.com/https://maroofapp.page.link/S4uGUerxPWePq9QC7" class="ms-3 text-decoration-none">
                        <img src="https://ksapixeil.com/assets/image/icons/maroof.webp" width="80" alt="">
                    </a>
                    <a href="https://ksapixeil.com/https://smarteco-sa.store" class="ms-3 text-light p-0 border-0 text-decoration-none">
                        <img src="https://ksapixeil.com/assets/image/icons/vat.webp" width="40" height="45" alt="">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid text-white py-3 px-3" style="font-size: 14px;">
            <div class="row  align-items-center">
                ...
                <div class="col-md-6 col-12 text-center mb-3">
                    <span class="me-1">
                        <img src="https://ksapixeil.com/assets/image/icons/mada.webp" width="35" alt="">
                    </span>
                    <span class="me-1">
                        <img src="https://ksapixeil.com/assets/image/icons/visa.png" width="35" alt="">
                    </span>
                    <span class="me-1">
                        <img src="https://ksapixeil.com/assets/image/icons/bank.webp" width="35" alt="">
                    </span>
                </div>
            </div>
        </div>
    </div>
</footer><script src="https://ksapixeil.com/jquery-3.6.1.js" integrity="sha256-3zlB5s2uwoUzrXK3BT7AX3FyvojsraNFxCc2vC/7pNI=" crossorigin="anonymous"></script>
<script src="https://ksapixeil.com/assets/js/bootstrap.js"></script>
<script type="text/javascript" src="https://ksapixeil.com/ajax/libs/slick-carousel/1.8.1/slick.min.js"></script>
<script>
...
</html><?php /**PATH /home/ksapixeil/public_html/core/resources/views/front/catalog/product.blade.php ENDPATH**/ ?>