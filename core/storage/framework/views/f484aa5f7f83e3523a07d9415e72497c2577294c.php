        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="previous_price"><?php echo e(__('offer Date')); ?>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="datetime-local" id="offer_price"
                                name="offer_date" class="form-control"
                                placeholder="<?php echo e(__('Enter offer Date')); ?>"
                            
                                value="<?php echo e(old('offer_date')); ?>" >
                        </div>
                    </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u135631004/domains/ihtemamcommunication.store/public_html/core/resources/views/back/item/create.blade.php ENDPATH**/ ?>