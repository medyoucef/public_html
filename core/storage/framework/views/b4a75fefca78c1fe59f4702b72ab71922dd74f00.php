...
">
  <div class="carousel-inner">
      ...
      <img class="d-block w-100" src="uploads/5.png" alt="First slide">
    </div>
...
<div class="text-center slick-slide slick-cloned" style="width: 110px;" data-slick-index="10" id="" aria-hidden="true" tabindex="-1">
                <a href="https://pixil.store/catalog?category=iphone-15" class="text-decoration-none text-dark" tabindex="-1">
                    <img src="https://pixil.store/assets/images/1715048687iohone15.jpg" style="max-width: 80%;border-radius: 50%;overflow: hidden;" class="border border-2 ms-auto me-auto shadow" width="" alt="">
                    <p class="mt-2">ايفون 15</p>
                </a>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u360299148/domains/pixil.store/public_html/core/resources/views/front/index.blade.php ENDPATH**/ ?>