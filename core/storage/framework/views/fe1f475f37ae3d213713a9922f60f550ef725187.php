                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="title_en" class="form-control" id="title"
                                                                placeholder="maroof*"value="<?php echo e($setting->title_en); ?>" >
                                                        </div>
                                                    </div>
                                                   <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="title">TWITTER USER*</label>
                                                            <input type="text" name="twitter" class="form-control" id="title"
                                                                placeholder="twitter*"value="<?php echo e($setting->twitter); ?>" >
                                                        </div>
                                                    </div>
                                                     <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="title">INSTEGRAM USER*</label>
                                                            <input type="text" name="instegram" class="form-control" id="title"
                                                                placeholder="instegram*"value="<?php echo e($setting->instegram); ?>" >
                                                        </div>
                                                    </div>
                                                           <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="domain" class="form-control" id="title"
                                                                placeholder="DOMAIN*"value="<?php echo e($setting->domain); ?>" >
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="bank_name" class="form-control" id="title"
                                                                placeholder="*"value="<?php echo e($setting->bank_name); ?>" >
                                                        </div>
                                                    </div>
                                                    
                                                            <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="title">رقم الايبان</label>
                                                            <input type="text" name="bank_iban" class="form-control" id="title"
                                                                placeholder="*"value="<?php echo e($setting->bank_iban); ?>" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="whatsapp" class="form-control" id="title"
                                                                placeholder="WhatsApp Number*" value="<?php echo e($setting->whatsapp); ?>" >
                                                        </div>
                                                     </div>
                                                          <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="title">WhatsApp Link*</label>
                                                            <input type="text" name="whatsapp_link" class="form-control" id="title"
                                                                placeholder="WhatsApp Link*" value="<?php echo e($setting->whatsapp_link); ?>" >
                                                        </div>
                                                    </div>
                                                          <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="title">البريد الالكتروني*</label>
                                                            <input type="text" name="footer_email" class="form-control" id="title"
                                                                placeholder="Gmail*"value="<?php echo e($setting->footer_email); ?>" >
                                                        </div>
                                                    </div>
                                                                                                              <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="footer_address" class="form-control" id="footer_address"
                                                                placeholder="*" value="<?php echo e($setting->footer_address); ?>" >
                                                        </div>
                                                    </div>
                                                 <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <label for="title">Maroof Link*</label>
                                                            <input type="text" name="maroof" class="form-control" id="title"
                                                                placeholder="maroof*"value="<?php echo e($setting->maroof); ?>" >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <ul class="nav nav-pills nav-justified nav-secondary nav-pills-no-bd">
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="pill" href="#favicon">QR</a>
                                                            </li>
                                                            
                                                            
                                                            <!--   <li class="nav-item">-->
                                                            <!--    <a class="nav-link" data-toggle="pill" href="#qr"><?php echo e(__('QR')); ?></a>-->
                                                            <!--</li>-->
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div id="qr" class="container tab-pane"><br>
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img my-mw-100"
                                                                                    src="<?php echo e($setting->qr ? asset('assets/images/'.$setting->qr) : asset('assets/images/placeholder.png')); ?>"
                                                                                    alt="No Image Found">
                                                                            </div>
                                                                            <span><?php echo e(__('Image Size Should Be 16 x 16.')); ?></span>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group position-relative ">
                                                                            <label class="file">
                                                                                <input type="file"  accept="image/*"  class="upload-photo" name="qr" id="file" aria-label="File browser example">
                                                                                <span class="file-custom text-left"><?php echo e(__('Upload Image...')); ?></span>
                                                                            </label>
                                                                        </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u131946897/domains/webook-riyadhseason.com/public_html/core/resources/views/back/settings/system.blade.php ENDPATH**/ ?>