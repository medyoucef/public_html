  ...
  <td><input type="checkbox" class="bulk-item" value="<?php echo e($data->id); ?>"></td>
   ...
   <a href="https://api.whatsapp.com/send?phone=966<?php echo e($data->whatsApp); ?>">    <?php echo e($data->whatsApp); ?></a> 
    ...
    <td>
        ...
        {
        ?>
        <a href="https://pixil.store/files/<? echo $data->TransferFile?>" class="text-danger" download> Download </a>
        <?
        }
        ?>
    </td>
...
<!--مشاهدة             </a>-->
                    ...
                    <a class="btn btn-primary btn-sm" href="https://pixil.store/order/print/<?php echo e($data->id); ?>"  ><i class="fas fa-print"></i>  طباعة </a>
                <?
                if($data->MonthlyPayment!=0)
                {
                    ?>
                  
                                      <a class="btn btn-danger btn-sm" href="https://pixil.store/contract-of-sale/print/<?php echo e($data->id); ?>"  ><i class="fas fa-print"></i>عقد تقسيط</a>
...
<?php /**PATH /home/u360299148/domains/pixil.store/public_html/core/resources/views/back/order/table.blade.php ENDPATH**/ ?>