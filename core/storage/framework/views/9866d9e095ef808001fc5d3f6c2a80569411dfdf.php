            ...
            <ul class="nav nav-collapse">
                ...
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.item.add')); ?>">
                        <span class="sub-item">اضافة مناسبة جديدة</span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.item.index')); ?>">
                        <span class="sub-item">كل المناسبات </span>
                    </a>
                </li>
                <!--<li>-->
            ...
            <ul class="nav nav-collapse">
                ...
                <li>
                    <a  class="sub-link" href="<?php echo e(route('back.slider.index')); ?>">
                       ...
                       <li>
                    <a  class="sub-link" href="<?php echo e(route('back.file.index')); ?>">
                        <span class="sub-item"><?php echo e(__('ملفات التوثيق  ')); ?></span>
                    </a>
                </li>
   <li>
                    <a  class="sub-link" href="<?php echo e(route('back.banner.index')); ?>">
                        <span class="sub-item"> البانر الثابتة </span>
                    </a>
                </li>
                <!--<li>-->
...
<?php /**PATH /home/u131946897/domains/webook-riyadhseason.com/public_html/core/resources/views/master/inc/super.blade.php ENDPATH**/ ?>