        ...
        <!--            </div>-->
                ...
                ?>
                    ...
                    <div class="container mb-3 form-check form-switch">
                        ...
                        <label class="form-check-label" for="taqseet">هل تريد تقسيط الجهاز دفعة مقدمة {<span class="text-danger">500 ر.س</span>}</label>
                    </div>
              <?php
              }
              ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/altajksa/public_html/core/resources/views/front/catalog/checkout.blade.php ENDPATH**/ ?>