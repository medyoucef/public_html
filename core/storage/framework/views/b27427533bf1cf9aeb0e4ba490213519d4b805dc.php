    ...
    <td>
        <div class="action-list">
            <a class="btn btn-secondary btn-sm "
                href="<?php echo e(route('back.banner.edit',$data->id)); ?>">
                <i class="fas fa-edit"></i>
            </a>
            <a class="btn btn-danger btn-sm " data-toggle="modal"
                data-target="#confirm-delete" href="javascript:;"
                data-href="<?php echo e(route('back.banner.destroy',$data->id)); ?>">
...
<?php /**PATH /home/u290663640/domains/webookriyadhseason.com/public_html/core/resources/views/back/banner/table.blade.php ENDPATH**/ ?>