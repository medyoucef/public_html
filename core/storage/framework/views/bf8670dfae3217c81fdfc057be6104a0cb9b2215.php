        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12 mb-5">
                ...
                <div class="text-center mt-5">
                    <a href="https://<?php echo e($setting->title_en); ?>-sa.store" class="text-light p-0 border-0 text-decoration-none">
                        <img src="assets/image/icons/qr-code.png" width="50" alt="">
                    </a>
                    <a href="<?php echo e($setting->maroof); ?>" class="ms-3 text-decoration-none">
                        <img src="assets/image/icons/maroof.webp" width="80" alt="">
                    </a>
                    <a href="https://<?php echo e($setting->title_en); ?>-sa.store" class="ms-3 text-light p-0 border-0 text-decoration-none">
...
</html><?php /**PATH /home/ihtemamcommunica/public_html/core/resources/views/layouts/master.blade.php ENDPATH**/ ?>