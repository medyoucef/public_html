...
<head>
    ...
    <link rel="icon"  type="image/x-icon" href="<?php echo e(asset('assets/images/'.$setting->logo)); ?>"/>
		...
		<div class="main-header " >
			...
			<div class="logo-header">
				...
				<a href="<?php echo e(route('back.dashboard')); ?>" class="logo">
					<img src="<?php echo e(asset('assets/images/'.$setting->logo)); ?>" alt="navbar brand" class="navbar-brand">
				</a>
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="<?php echo e(route('back.dashboard')); ?>" aria-expanded="false">
								<div class="avatar-sm avatar avatar-sm">
									<img src="<?php echo e(asset('assets/images/'.$setting->logo)); ?>" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										<div class="avatar-lg"><img src="<?php echo e(asset('assets/images/'.$setting->logo)); ?>" alt="image profile" class="avatar-img rounded"></div>
...
<?php /**PATH /home/u131946897/domains/webook-riyadhseason.com/public_html/core/resources/views/master/back.blade.php ENDPATH**/ ?>