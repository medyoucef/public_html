...
<div class="container col-md-5">
    ...
    <div id="bankTransfer-Form" style="display: none;">
              ...
              <div class="form-floating mb-3">
                <p style="color:green;text-align:center;font-weight: 700;">للدفع عن طريق التحويل البنكي الرجاء التواصل معنا عن طريق الواتساب لمزيد من التفاصيل </p>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/altajksa/public_html/core/resources/views/front/catalog/checkout2.blade.php ENDPATH**/ ?>