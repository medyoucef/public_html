...
<?php if(in_array($_GET['id'], [1349, 1352])){?>
    ...
    <div class="container">
        ...
        <div class="legend">
            <div class="legend-item">
                ...
                <span>Royal - 750 ريال</span>
            </div>
            <div class="legend-item">
                <div class="legend-color diamond"></div>
                <span>Diamond - 600 ريال</span>
            </div>
            <div class="legend-item">
                <div class="legend-color orange"></div>
                <span>Platinum - 500 ريال</span>
            </div>
            <div class="legend-item">
                <div class="legend-color black"></div>
                <span>Gold - 200 ريال</span>
            </div>
            <div class="legend-item">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u292165191/domains/webookticket.com/public_html/core/resources/views/front/book.blade.php ENDPATH**/ ?>