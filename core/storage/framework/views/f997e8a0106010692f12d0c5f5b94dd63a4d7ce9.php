...
?>
            ...
            <div class="col-md-4 col-12 mb-3">
                <div class="w-100">
                    ...
                    <div class="container text-center mb-3 d-flex justify-content-center">
                        ...
                        <a href="<?php echo e($setting->footer_email); ?>" class="text-decoration-none">
                            <div class="text-dark px-3 rounded" style="background-color: #ECEDEF;">
    ...
    <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="<?php echo e(asset('assets/images/'.$data->photo)); ?>" class="text-light p-0 border-0 text-decoration-none">
                        <img src="<?php echo e(asset('assets/images/'.$data->logo)); ?>" width="70" alt="">
                    </a>
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!--<a href="<?php echo e(route('qr-code')); ?>" class="text-light p-0 border-0 text-decoration-none">-->
                    <!--    <img src="assets/image/icons/qr-code.png" width="50" alt="">-->
                    <!--</a>-->
                    <!--<a href="<?php echo e(route('maroof')); ?>" class="ms-3 text-decoration-none">-->
                    <!--    <img src="assets/image/icons/maroof.webp" width="80" alt="">-->
                    <!--</a>-->
                    <!--<a href="<?php echo e(route('vat')); ?>" class="ms-3 text-light p-0 border-0 text-decoration-none">-->
...
<?php /**PATH /home/u593058701/domains/altaj-ksa.store/public_html/core/resources/views/front/includes/footer.blade.php ENDPATH**/ ?>