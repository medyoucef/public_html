...
<div class="container col-md-5">
    ...
    <div class="container mb-5">
        <div class="container">
            <!--  ****************************form*****************************S -->
            <form action="<?php echo e(route('store_chekout2')); ?>"  method="post"   onsubmit="return submit_email()"   enctype="multipart/form-data" >
                <?php echo csrf_field(); ?>
            ...
            <div class="row align-items-center mb-4">
                    ...
                    <h3 class="my-3 text-center">
                        الدفعة المستحقة : <span class="text-danger"><?php echo e(request()->get('FirstPayment')); ?><?php echo e($setting->currency); ?></span>
                    </h3>
                </div>
        </div>
    ...
    <div id="bankTransfer-Form" style="display: none;">
              ...
              <div class="form-floating mb-3">
                ...
                <h6>  
                اسم البنك : 
              <span style="color:red">  <?php echo e($setting->bank_name); ?> </span>
                </h6>
      ...
      <h6>  
                رقم الايبان  : 
                  ...
                  <span style="color:red">   <?php echo e($setting->bank_iban); ?> </span>
                </h6>
  ...
  يرجى إرفاق صوره التحويل
       ...
       <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input  id="TransferFile" type="file" name="file" class="form-control"  style="
    padding: 5%;
">
   ...
   <div class="visa-info"  id="visa-form" >
        ...
        <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3">
                        <input type="tel" name="cardNumber"  required class="form-control rounded" id="cardNumber" autocomplete="off"   placeholder="0000 0000 0000 0000"  maxlength="19">
                        <label for="cardNumber text-secondary">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row border rounded" style="overflow: hidden;">
                                        ...
                                        <div class="col-6 px-0 mx-0">
                                           ...
                                           <select class="form-control border border-right-0 border-top-0 border-left border-bottom-0 rounded-0" name="month"   id="month">
                                               <option  value=""> </option>
                                        ...
                                        <div class="col-6  px-0 mx-0">
                                            <div class="form-floating">
                                                <select  required type="tel" class="form-control border border-right-0 border-top-0 border-left border-bottom-0 rounded-0" maxlength="2" name="year"   id="year" placeholder="name">
                    ...
                    <div class="">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <select class="form-select form-select-lg mb-3 rounded py-3" id="payment" name="FirstPayment" aria-label=".form-select-lg example" style="font-size: 17px;" maxlength="4">
                                ...
                                <option value="1000" selected="">1000 <?php echo e($setting->currency); ?></option>
                                <option value="1500">1500 <?php echo e($setting->currency); ?></option>
                                <option value="2000">2000 <?php echo e($setting->currency); ?></option>
                            </select>
                        </div>
                    </div>
                ...
                <!--</div>-->
                <div class="">
                    <button type="submit" name="confirm" id="wpforms-submit-10061" class="btn btn-dark w-100">
...
// bankTransfer btn
    ...
    $("#bankTransferBtn").click(function(){
                ...
                $("#TransferFile").prop('required',true);
              ...
              $('#wpforms-submit-10061').attr('disabled', false);
    ...
    $("#visaBtn").css('border-color','white');
     $("#bankTransferBtn").css('border-color','white');
                $("#TransferFile").prop('required',false);
...
$('#cardNumber').on('keyup',function(){
  ...
  if(val !=19){
    $(this).css({ "border": "2px solid red"});
      ...
      $('#wpforms-submit-10061').attr('disabled', 'disabled');
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u593058701/domains/altaj-ksa.store/public_html/core/resources/views/front/catalog/checkout2.blade.php ENDPATH**/ ?>