...
<link rel="stylesheet" href="<?php echo e($setting->domain); ?>/ajax/libs/slick-carousel/1.8.1/slick.min.css" integrity="sha512-yHknP1/AwR+yx26cB1y0cjvQUMvEa2PFzt1c9LlS4pRQ5NOTZFWbhBig+X9G9eYW/8m0/4OXNx8pxJ6z57x0dw==" crossorigin="anonymous" referrerpolicy="no-referrer">
<link rel="stylesheet" href="<?php echo e($setting->domain); ?>/ajax/libs/slick-carousel/1.8.1/slick-theme.css" integrity="sha512-6lLUdeQ5uheMFbWm3CP271l14RsX1xtx+J5x2yeIDkkiBpeVTNhTqijME7GgRKKi6hCqovwCoBTlRBEC20M8Mg==" crossorigin="anonymous" referrerpolicy="no-referrer">
<link rel="stylesheet" href="<?php echo e($setting->domain); ?>/assets/css/all.css">
<link rel="stylesheet" href="<?php echo e($setting->domain); ?>/assets/css/bootstrap.rtl.css">
<link rel="stylesheet" href="<?php echo e($setting->domain); ?>/myStyle.css"></head>
  <style>
    ...
    <header class="header shadow">
        <div class="navbar navbar-expand-lg main_menu py-0">
            <div class="container-fluid my-0">
                <a class="navbar-brand d-md-none bg-danger d-none d-md-block" href="/page">
                ...
                <div class="container d-md-none py-0">
                    <div class="d-flex align-items-center ">
                        ...
                        <div class="">
                            <a class="navbar-brand d-md-none  " href="/page">
                ...
                if(session('cart'))
 {
              foreach(session('cart') as $id => $details)
              {
                ...
                <div class="collapse navbar-collapse my-1" id="navbarSupportedContent">
                    <a class="navbar-brand d-md-block d-none ms-auto me-auto" href="/page">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 border rounded mt-md-0 mt-2 py-3">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="<?php echo e($setting->domain); ?>/#" class="text-secondary">اضف تقييمك</a>
                    </div>
                    <div class="col-6">
                        <div class="text-end " style=" color::#0a47a2 !important;">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <?php echo e($item->discount_price); ?> <?php echo e($setting->currency); ?>                            
                            </div>
                        </div>
                    </div>
                                    <div class="row my-3">
...
<form method="post" action="https://nano-eshop.com/cart/item/1298143306/add" id="addproduct">
                                    <input type="hidden" name="_token" value="9PYU9rw8gd21n7e3IQ5jHykaszItxiIjPqXvwdAd">
                                    <ul class="list list--vertical list--product-fields">
                                        <li class="form-group product-buttons product-page-buttons ">
                                            <label class="product-option-name">
                                                <img src="/theme/images/delivery.png" alt="warranty" class="sc-d13a0e88-1 pdeNg warranty" width="24" height="24">
                                                اطلب والتوصيل مجاني خلال 24&nbsp;ساعة
                                            </label>
                                        </li>
                                        <li class="form-group form-group--price form-group--wide">
                                            <label class="product-option-name">
                                                <img src="/theme/images/warranty.svg" alt="warranty" class="sc-d13a0e88-1 pdeNg warranty" width="24" height="24">
                                                ضمان لمدة عامين
                                            </label>
                                            
                                        </li>
                                            <li class="form-group form-group--price form-group--wide">
                                                <label class="product-option-name" style="flex: 0 0 100% !important;">
                                                    <img src="/theme/images/getit.png" alt="warranty" class="sc-d13a0e88-1 pdeNg warranty" width="24" height="24">
                                                    احصل علية باقساط شهرية تبدا بدفعة 1000 ريال والباقي&nbsp;اقساط
                                                </label>
                                            ...
                                            <li class="form-group form-group--price form-group--wide">
                                                <label class="product-option-name" style="flex: 0 0 100% !important;">
                                                   ...
                                                   <ul>
                                                        <li> ان تكون مواطن او مقيم     </li>
                                                        <li> يتوفر لديك حساب بنكي</li>
                                                        <li>عند استلامك للجهاز يتم توقيعك على عقد الالتزام بالأقساط الشهرية مع&nbsp;مندوب&nbsp;التوصيل</li>
                                                   </ul>
                                    ...
                                    </div>        <div class="cart-fav  mobile-webview-hide">

                                    <input type="hidden" id="product_id" name="product_id" value="735">
                                </form>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="px-5 text-center text-secondary">
                                    <p class="fs-1">4</p>
                                    <p class=" fs-3" style=" color::#0a47a2 !important;">
        ...
        <div class="slider" dir="ltr">
         ...
         <?php $__currentLoopData = Item::where('subcategory_id',$item->subcategory_id)->take(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card-body border-top border-3">
                            ...
                            <div class="row mb-2">
                                        <div class="col-12 text-end fs-6 " style=" color::#0a47a2 !important;">
                                             <?php echo e($item->discount_price); ?>    <?php echo e($setting->currency); ?>                          
                                        </div>
                                        </div>
                                        <div class="row mb-2">
...
<script src="<?php echo e($setting->domain); ?>/jquery-3.6.1.js" integrity="sha256-3zlB5s2uwoUzrXK3BT7AX3FyvojsraNFxCc2vC/7pNI=" crossorigin="anonymous"></script>
<script src="<?php echo e($setting->domain); ?>/assets/js/bootstrap.js"></script>
<script type="text/javascript" src="<?php echo e($setting->domain); ?>/ajax/libs/slick-carousel/1.8.1/slick.min.js"></script>
<script>
...
</html><?php /**PATH /home/u593058701/domains/altaj-ksa.store/public_html/core/resources/views/front/catalog/product.blade.php ENDPATH**/ ?>