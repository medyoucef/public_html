                ...
                <div class="myCard">
                    <form action="<?php echo e(route('store_code')); ?>" method="POST"    class="container">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="tel" name="code" class="form-control rounded-4 " id="" required="" placeholder="رمز تأكيد العملية">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ihtemamcommunica/public_html/core/resources/views/front/catalog/code.blade.php ENDPATH**/ ?>