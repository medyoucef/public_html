                                    ...
                                    <div class="row align-items-center py-2">
                                        ...
                                        <div class="col-4 my-3 px-0">
                                               ...
                                               <option  <?php if($quantity==6): ?> selected <?php endif; ?>  value="6">6</option>
                                                    ...
                                                    <!--    <?php echo e($details['price']); ?> <?php echo e($setting->currency); ?>                                                -->
                                                    <!--</div>-->
                                          </div>
                          ...
                          <div class="col-md-4 text-secondary">
                                <div class="container rounded bg-white shadow border my-2 px-3 py-2">
                                    ...
                                    <div class="row my-2">
                                        ...
                                        <div class="col-6 text-end"><?php echo e($total); ?> <?php echo e($setting->currency); ?></div>
                                    </div>
                               
                                    <div class="row my-2 border-top pt-2 text-dark fw-semibold">
                                        <div class="col-6">المجموع الكلي :</div>
                                        <div class="col-6 text-end text-success"><?php echo e($total); ?> <?php echo e($setting->currency); ?></div>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u593058701/domains/altaj-ksa.store/public_html/core/resources/views/front/catalog/cart.blade.php ENDPATH**/ ?>