    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        <label for="sort_details">وصف قصير للحدث  *</label>
                    ...
                    <div class="form-group">
                        <label for="details"> وصف الحدث *</label>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="switch-primary">
                            ...
                            <span class="switch-text">أالتذاكر وأسعارها </span>
                        </label>
                    </div>
                            ...
                            <div class="flex-grow-1">
                                <div class="form-group">
                                    <input required type="text" class="form-control"
                                        ...
                                        placeholder="نوع التذكرة" value="<?php echo e($description); ?>">
                                    </div>
                            </div>
                               ...
                               <div class="flex-grow-1">
                                <div class="form-group">
                                    <input  required type="number" class="form-control"
                                        ...
                                        placeholder=" سعر التذكرة" value="<?php echo e($name); ?>">
                                    </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" id="meta_description"
                            ...
                            placeholder="<?php echo e(__('Enter Meta Description')); ?>" required ><?php echo e($item->meta_description); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-secondary mr-2">تحديث</button>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group ">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="discount_price"
                                ...
                                min="1" step="0.1"
                                value="<?php echo e($item->discount_price); ?>"
                    ...
                    <div class="form-group">
                        <label for="previous_price"> تاريخ الحدث
                            </label>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                            </div>
                             <input type="text" id="event_date"
                                ...
                                placeholder="<?php echo e(__('Enter offer Date')); ?>"
                                    value="<?php echo e($item->event_date); ?>"                                >
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="brand_id"> حدد المدينة  </label>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u131946897/domains/webook-riyadhseason.com/public_html/core/resources/views/back/item/edit.blade.php ENDPATH**/ ?>