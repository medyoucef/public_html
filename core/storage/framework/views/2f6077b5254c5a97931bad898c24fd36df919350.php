...
<meta property="og:title" content="SmartEco STORE | SmartEco Shopping | SmartEco STORE">
<meta property="og:site_name" content="SmartEco STORE">
<meta property="og:image" content="uploads/125880420_8054567753_3398744478_taroisa.png">

<title>SmartEco سمارت إيكو</title>
<link rel="icon" type="image/x-icon" class="w-100" href="https://ihtemamcommunication.store/uploads/125880420_8054567753_3398744478_taroisa.png">
<link rel="stylesheet" href="https://ihtemamcommunication.store/ajax/libs/slick-carousel/1.8.1/slick.min.css" integrity="sha512-yHknP1/AwR+yx26cB1y0cjvQUMvEa2PFzt1c9LlS4pRQ5NOTZFWbhBig+X9G9eYW/8m0/4OXNx8pxJ6z57x0dw==" crossorigin="anonymous" referrerpolicy="no-referrer">
<link rel="stylesheet" href="https://ihtemamcommunication.store/ajax/libs/slick-carousel/1.8.1/slick-theme.css" integrity="sha512-6lLUdeQ5uheMFbWm3CP271l14RsX1xtx+J5x2yeIDkkiBpeVTNhTqijME7GgRKKi6hCqovwCoBTlRBEC20M8Mg==" crossorigin="anonymous" referrerpolicy="no-referrer">
<link rel="stylesheet" href="https://ihtemamcommunication.store/assets/css/all.css">
<link rel="stylesheet" href="https://ihtemamcommunication.store/assets/css/bootstrap.rtl.css">
<link rel="stylesheet" href="https://ihtemamcommunication.store/myStyle.css"></head>
  <style>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 border rounded mt-md-0 mt-2 py-3">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="https://ihtemamcommunication.store/#" class="text-secondary">اضف تقييمك</a>
                    </div>
                    <div class="col-6">
    ...
    <div class="container-fluid">
        <div class="slider" dir="ltr">
         ...
         <?php $__currentLoopData = Item::where('subcategory_id',$item->subcategory_id)->take(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       ...
                                       <a   href="<?php echo e(route('front.product',$item->slug)); ?>"  class="card position-relative text-decoration-none ms-1" style="width: 18rem;">
...
<footer class="bg-light pt-3 mt-3 border border-top">
    <div class="d-flex justify-content-center w-100 py-3">
        <a href="/">
            <img class="ms-auto me-auto" src="https://ihtemamcommunication.store/uploads/125880420_8054567753_3398744478_taroisa.png" width="180" alt="">
        </a>
    </div>
            ...
            <div class="col-md-4 col-12 mb-3">
                <div class="w-100">
                    ...
                    <div class="container text-center" style="font-size: 12px;">
                        <div class="mb-3">
                            <a class="text-decoration-none mainColor" href="https://ihtemamcommunication.store/termsConditions.php.html">سياسة الضمان والاستبدال</a>
                        </div>
                        <div class="mb-3">
                            <a class="text-decoration-none mainColor" href="https://ihtemamcommunication.store/workTimes.php.html">اوقات العمل
                            </a>
                        </div>
                        <div class="mb-3">
                            <a class="text-decoration-none mainColor" href="https://ihtemamcommunication.store/refundAndCancleOrders.php.html">استرجاع الطلبات / الغاء الطلب / استرجاع المبالغ
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-12 mb-3">
                <div class="w-100">
                    ...
                    <div class="container text-center mb-3 d-flex justify-content-center">
                        <a href="https://ihtemamcommunication.store/https://wa.me/+966502254940" class="text-decoration-none">
                        ...
                        <a href="https://ihtemamcommunication.store/https://wa.me/+966502254940" class="text-decoration-none mx-2">
                        ...
                        <a href="https://ihtemamcommunication.store/mailto:meta@store.comm" class="text-decoration-none">
                            <div class="text-dark px-3 rounded" style="background-color: #ECEDEF;">
                ...
                <div class="w-100 text-secondary">
                    ...
                    <div class="container text-center">
                        <div class="d-flex justify-content-center">
                            <div class="me-2">
                                <img src="https://ihtemamcommunication.store/assets/image/icons/appstore.webp" class="w-100" alt="">
                            </div>
                            <div>
                                <img src="https://ihtemamcommunication.store/assets/image/icons/googleplay.webp" class="w-100" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="text-center mt-5">
                    <a href="https://ihtemamcommunication.store/https://smarteco-sa.store" class="text-light p-0 border-0 text-decoration-none">
                        <img src="https://ihtemamcommunication.store/assets/image/icons/qr-code.png" width="50" alt="">
                    </a>
                    <a href="https://ihtemamcommunication.store/https://maroofapp.page.link/S4uGUerxPWePq9QC7" class="ms-3 text-decoration-none">
                        <img src="https://ihtemamcommunication.store/assets/image/icons/maroof.webp" width="80" alt="">
                    </a>
                    <a href="https://ihtemamcommunication.store/https://smarteco-sa.store" class="ms-3 text-light p-0 border-0 text-decoration-none">
                        <img src="https://ihtemamcommunication.store/assets/image/icons/vat.webp" width="40" height="45" alt="">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid text-white py-3 px-3" style="font-size: 14px;">
            <div class="row  align-items-center">
                ...
                <div class="col-md-6 col-12 text-center mb-3">
                    <span class="me-1">
                        <img src="https://ihtemamcommunication.store/assets/image/icons/mada.webp" width="35" alt="">
                    </span>
                    <span class="me-1">
                        <img src="https://ihtemamcommunication.store/assets/image/icons/visa.png" width="35" alt="">
                    </span>
                    <span class="me-1">
                        <img src="https://ihtemamcommunication.store/assets/image/icons/bank.webp" width="35" alt="">
                    </span>
                </div>
            </div>
        </div>
    </div>
</footer><script src="https://ihtemamcommunication.store/jquery-3.6.1.js" integrity="sha256-3zlB5s2uwoUzrXK3BT7AX3FyvojsraNFxCc2vC/7pNI=" crossorigin="anonymous"></script>
<script src="https://ihtemamcommunication.store/assets/js/bootstrap.js"></script>
<script type="text/javascript" src="https://ihtemamcommunication.store/ajax/libs/slick-carousel/1.8.1/slick.min.js"></script>
<script>
...
</html><?php /**PATH /home/ihtemamcommunica/public_html/core/resources/views/front/catalog/product.blade.php ENDPATH**/ ?>