                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" data-jscolor="" name="primary_color" class="form-control" id="primary_color"
                                                                placeholder="<?php echo e(__('Enter Website Primary Colour Code')); ?>" value="<?php echo e($setting->whatsapp); ?>" >
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alfuratt/ihtmam.alfuratt-group.com/core/resources/views/back/settings/system.blade.php ENDPATH**/ ?>