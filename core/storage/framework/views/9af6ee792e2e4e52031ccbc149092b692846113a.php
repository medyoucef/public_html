                ...
                <div class="card-body">
                    <div class="text-center py-3">
                        ...
                        <div class="d-block mt-3">
                            <div class="numbers">
                                <h2 class="card-title"><b> أضافة منتج جديد </b></h2>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u135631004/domains/ihtemamcommunication.store/public_html/core/resources/views/back/item/add.blade.php ENDPATH**/ ?>