...
oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
    type = "number"
    maxlength = "10" id="wpforms-10061-field_6">                    
        ...
        <!--            </div>-->
                ...
                ?>
                    ...
                    <div class="container mb-3 form-check form-switch">
                        ...
                        <!--<label class="form-check-label" for="taqseet">هل تريد تقسيط الجهاز دفعة مقدمة {<span class="text-danger">1000 ر.س</span>}</label>-->
                                                <label class="form-check-label" for="taqseet" >هل تريد تقسيط الجهاز بدفعه مقدمه او الدفع كامل</label>
              ...
              ?>
                ...
                <div id="taqsetBox" class="d-none">
                    <h4 class="mb-3 text-center">اختر مده الأقساط لمعرفه القسط</h4>
                    <div class="">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <select   class="form-select form-select-lg mb-3 rounded py-3" id="payment" name="FirstPayment" aria-label=".form-select-lg example" style="font-size: 17px;" maxlength="4">
                                <option value="" selected  disabled="">اختر الدفعة الاولى</option>
                                <option value="<?php echo e($total); ?>">الدفع كامل  </option>
                    ...
                    <div class="">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded"  disabled autocomplete="off" name="floatingInput" id="floatingInput"   placeholder="name@example.com">
...
$('#wpforms-10061-field_6').on('keyup',function(){
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u593058701/domains/altaj-ksa.store/public_html/core/resources/views/front/catalog/checkout.blade.php ENDPATH**/ ?>