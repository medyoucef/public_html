...
<!--مشاهدة             </a>-->
            ...
            <a class="btn btn-info btn-sm" href="<?php echo e($setting->domain); ?>/order/print/<?php echo e($data->id); ?>"  ><i class="fas fa-print"></i>الفاتورة </a>
                  ...
                  <a class="btn btn-success btn-sm" href="<?php echo e($setting->domain); ?>/order/RecepitVoucher/<?php echo e($data->id); ?>"  ><i class="fas fa-print"></i>سند قبض  </a>
...
<?php /**PATH /home/pixil/public_html/core/resources/views/back/order/table.blade.php ENDPATH**/ ?>