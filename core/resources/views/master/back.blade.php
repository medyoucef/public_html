...
<head>
    ...
    <link rel="icon"  type="image/x-icon" href="{{ asset('assets/images/'.$setting->logo) }}"/>
		...
		<div class="main-header " >
			...
			<div class="logo-header">
				...
				<a href="{{route('back.dashboard')}}" class="logo">
					<img src="{{asset('assets/images/'.$setting->logo)}}" alt="navbar brand" class="navbar-brand">
				</a>
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="{{route('back.dashboard')}}" aria-expanded="false">
								<div class="avatar-sm avatar avatar-sm">
									<img src="{{asset('assets/images/'.$setting->logo)}}" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										<div class="avatar-lg"><img src="{{asset('assets/images/'.$setting->logo)}}" alt="image profile" class="avatar-img rounded"></div>
