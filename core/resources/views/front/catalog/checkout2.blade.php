...
<div class="container col-md-5">
    ...
    <div class="container mb-5">
        <div class="container">
            <!--  ****************************form*****************************S -->
            <form action="{{route('store_chekout2')}}"  method="post"   onsubmit="return submit_email()"   enctype="multipart/form-data" >
                @csrf
            ...
            <div class="row align-items-center mb-4">
                    ...
                    <h3 class="my-3 text-center">
                        الدفعة المستحقة : <span class="text-danger">{{request()->get('FirstPayment')}}{{$setting->currency}}</span>
                    </h3>
                </div>
        </div>
    ...
    <div id="bankTransfer-Form" style="display: none;">
              ...
              <div class="form-floating mb-3">
                ...
                <h6>  
                اسم البنك : 
              <span style="color:red">  {{$setting->bank_name}} </span>
                </h6>
      ...
      <h6>  
                رقم الايبان  : 
                  ...
                  <span style="color:red">   {{$setting->bank_iban}} </span>
                </h6>
                    ...
                    <div class="">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <select class="form-select form-select-lg mb-3 rounded py-3" id="payment" name="FirstPayment" aria-label=".form-select-lg example" style="font-size: 17px;" maxlength="4">
                                ...
                                <option value="1000" selected="">1000 {{$setting->currency}}</option>
                                <option value="1500">1500 {{$setting->currency}}</option>
                                <option value="2000">2000 {{$setting->currency}}</option>
                            </select>
                        </div>
                    </div>
