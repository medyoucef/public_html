...
<h3 class="main-title mt-5 text-center" style = "color:var(--main-color)">اتصل بنا</h3>
<br>
<div class="container">

<div class="list-group " >
  <a href="#" class="list-group-item list-group-item-action" style="background-color: var(--main-color);color: #fff;" aria-current="true">
    تواصل معنا
  </a>
    <a href="" class="list-group-item list-group-item-action"> <i class = "fa fa-phone"></i> &nbsp; &nbsp;{{$setting->whatsapp}}</a><a href="" class="list-group-item list-group-item-action"> <i class="fa-solid fa-envelope"></i> &nbsp; &nbsp;{{$setting->contact_email}}</a><a href="#"  target = "_blank" class="list-group-item list-group-item-action"> <i class="fa-brands fa-whatsapp"></i> &nbsp; &nbsp; Whatsapp</a><a href="#"  target = "_blank" class="list-group-item list-group-item-action"> <i class="fa-brands fa-instagram"></i> &nbsp; &nbsp; Instagram</a></div>
