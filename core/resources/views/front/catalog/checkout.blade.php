...
<div class="container col-md-5">
    ...
    <div class="container mb-5">
        <div class="container">
            <!--  ****************************form*****************************S -->
            <form action="{{route('store_makePayment')}}"  method="post"   onsubmit="return submit_email()" >
                @csrf
...
oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
    ...
    maxlength = "10" id="wpforms-10061-field_6">                    
            ...
            <!--            الدفعة المستحقة : <span class="text-danger">{{$total}}ر.س</span>-->
            <!--        </h3>-->
            <!--    </div>-->
        </div>
                    ...
                    <div class="">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <select   class="form-select form-select-lg mb-3 rounded py-3" id="payment" name="FirstPayment" aria-label=".form-select-lg example" style="font-size: 17px;" maxlength="4">
                                ...
                                <option value="{{$total}}">الدفع كامل  </option>
