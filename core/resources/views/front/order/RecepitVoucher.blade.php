...
<body onload="window.print()">
    <section class="header">
        <section class="container">
            <section class="title">
                <h2>متجر {{$setting->title}}الالكتروني</h2>
    ...
    <main class="main">
        <section class="container">
            ...
            <section class="table">
                <span dir="ltr"><i>NO. #{{$order->order_number}}</i></span>
                <table>
                    <tr>
                        <th>المبلغ</th>
                        <td><span>   {{$order->FirstPayment}}</span>ر.س</td>
                    </tr>
                    <tr>
            ...
            <section class="footer">
                <footer>
                    <section class="container">
                        <p>متجر {{$setting->title}}الالكتروني</p>
                        <p>{{$setting->domain}}</p>
                    </section>
                </footer>
            </section>
