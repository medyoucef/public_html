                            ...
                            <span class="sicon-search"></span>
                             ...
                             $count = 0; 
                              ...
                              @endphp
                                 ...
                                 @endif
                    <a href="{{route('my_cart')}}" class="circle-action site-header__cart" data-cart-small="" rel="nofollow">
                        <span class="sicon-cart"></span> <span class="badge" id="cart_badge" data-cart-badge="">   {{$count}} </span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <li id="1" class="has-children">
            ...
            <ul>
                @foreach ($pcategory->subcategory as $scategory)
                    <li id="12">
                        <a href="{{route('front.catalog').'?subcategory='.$scategory->slug}}">{{$scategory->name}}</a>
                    </li>
