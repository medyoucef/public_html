    ...
    @if ($setting->campaign_status == 1)
        <div class="deal-of-day-section mt-20">
            <div class="container">
                ...
                <!--                    @endif-->
                <!--                    <img class="lazy" src="{{asset('assets/images/'.$compaign_item->item->thumbnail)}}" alt="Product">-->
                ...
                <!--                        <h3 class="product-title text-center text-dark"><a href="{{route('front.product',$compaign_item->item->slug)}}">-->
                <!--                            {{ strlen(strip_tags($compaign_item->item->name)) > 150 ? substr(strip_tags($compaign_item->item->name), 0, 150) : strip_tags($compaign_item->item->name) }}-->
                <!--                        </a></h3>-->
                ...
                <!--             <button class="product-button add_to_single_cart btn btn-outline-primary bg-light" data-target="{{ $compaign_item->item->id}}" href="javascript:;" title="To Cart" style="    width: 100%;">إضافة للسلة-->
                <!--                            </button>-->
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    <div class="product-thumb">
                                        ...
                                        @endif
                                            <img class="lazy" src="{{asset('assets/images/'.$popular_category_item->thumbnail)}}" alt="Product">
                                            <div class="product-button-group">
                ...
                <div class="row gx-3">
                    <div class="col-md-4">
                        <a href="{{$banner_secend['url1']}}" class="genius-banner">
                            <img class="lazy" src="{{ asset('assets/images/'.$banner_secend['img1']) }}" alt="">
                            <div class="inner-content">
                    ...
                    <div class="col-md-4">
                        <a href="{{$banner_secend['url2']}}" class="genius-banner">
                            <img class="lazy" src="{{ asset('assets/images/'.$banner_secend['img2']) }}" alt="">
                            <div class="inner-content">
                    ...
                    <div class="col-md-4">
                        <a href="{{$banner_secend['url3']}}" class="genius-banner">
                            <img class="lazy" src="{{ asset('assets/images/'.$banner_secend['img3']) }}" alt="">
                            <div class="inner-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                            <div class="links">
                                <a data-href="{{route('front.get.product','feature')}}" data-target="type_product_view" href="javascript:;" class="product_get active">منتجاتنا المميزة </a>
                                <a data-href="{{route('front.get.product','best')}}" data-target="type_product_view" class="product_get" href="javascript:;">الأكثر مبيعا</a>
                                <a data-href="{{route('front.get.product','top')}}" data-target="type_product_view" class="product_get" href="javascript:;">الأعلي تقيما</a>
                                <a data-href="{{route('front.get.product','new')}}" data-target="type_product_view" class="product_get" href="javascript:;">وصل حديثا</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="slider-item">
                                        <div class="product-card ">
                                            <div class="product-thumb">
                                                ...
                                                @endif
                                                <img class="lazy" src="{{asset('assets/images/'.$item->thumbnail)}}" alt="Product">
                                                <div class="product-button-group">
                                    ...
                                    <div class="slider-item">
                                        ...
                                        <div class="product-card p-col">
                                            <a class="product-thumb" href="{{route('front.product',$two_column_category_item->slug)}}">
                                                ...
                                                <img class="lazy" src="{{asset('assets/images/'.$two_column_category_item->thumbnail)}}" alt="Product"></a>
                                    <div class="product-card-body">
                ...
                <div class="row gx-3">
                    <div class="col-md-6">
                        <a href="{{$banner_third['url1']}}" class="genius-banner">
                            <img class="lazy" src="{{ asset('assets/images/'.$banner_third['img1']) }}" alt="">
                            <div class="inner-content">
                    ...
                    <div class="col-md-6">
                        <a href="{{$banner_third['url2']}}" class="genius-banner">
                            <img class="lazy" src="{{ asset('assets/images/'.$banner_third['img2']) }}" alt="">
                            <div class="inner-content">
        ...
        <section class="selected-product-section featured_cat_sec sps-two mt-50">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                            <h2 class="h3">المنتجات المميزة </h2>
                            <div class="links">
                    ...
                    <div class="col-gd">
                        <div class="product-card">
                            <div class="product-thumb" >
                                ...
                                @endif
                                    <img class="lazy" src="{{asset('assets/images/'.$feature_category_item->thumbnail)}}" alt="Product">
                                    <div class="product-button-group">
                            ...
                            <div class="product-card-body">
                                ...
                                <h3 class="product-title"><a href="{{route('front.product',$feature_category_item->slug)}}">
                                    {{ strlen(strip_tags($feature_category_item->name)) > 150 ? substr(strip_tags($feature_category_item->name), 0, 150) : strip_tags($feature_category_item->name) }}
                                </a></h3>
                                ...
                                <div class="slider-item">
                                    <a href="{{route('front.blog.details',$post->slug)}}" class="blog-post">
                                        <div class="post-thumb">
                                            <img class="lazy" src="{{ asset('assets/images/' . json_decode($post->photo, true)[array_key_first(json_decode($post->photo, true))]) }}"
                                                alt="Blog Post">
                                            </div>
                                        <div class="post-body">
        ...
        <section class="brand-section mt-30 mb-60">
            <div class="container ">
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="section-title">
                            <h2 class="h3">علامات تجارية مشهورة</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
