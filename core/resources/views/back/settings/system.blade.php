                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="title_en" class="form-control" id="title"
                                                                placeholder="maroof*"value="{{$setting->title_en}}" >
                                                        </div>
                                                    </div>
                                                   <div class="col-lg-8">
                                                        <div class="form-group">
                                                     ...
                                                     <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="instegram" class="form-control" id="title"
                                                                placeholder="instegram*"value="{{$setting->instegram}}" >
                                                        </div>
                                                    </div>
                                                           <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="domain" class="form-control" id="title"
                                                                placeholder="DOMAIN*"value="{{$setting->domain}}" >
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="bank_name" class="form-control" id="title"
                                                                placeholder="*"value="{{$setting->bank_name}}" >
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="bank_iban" class="form-control" id="title"
                                                                placeholder="*"value="{{$setting->bank_iban}}" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="footer_email" class="form-control" id="title"
                                                                placeholder="Gmail*"value="{{$setting->footer_email}}" >
                                                        </div>
                                                    </div>
                                                                                                              <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="footer_address" class="form-control" id="footer_address"
                                                                placeholder="*" value="{{$setting->footer_address}}" >
                                                        </div>
                                                    </div>
                                                 <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="maroof" class="form-control" id="title"
                                                                placeholder="maroof*"value="{{$setting->maroof}}" >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <ul class="nav nav-pills nav-justified nav-secondary nav-pills-no-bd">
                                                            ...
                                                            <!--   <li class="nav-item">-->
                                                            <!--    <a class="nav-link" data-toggle="pill" href="#qr">{{ __('QR') }}</a>-->
                                                            <!--</li>-->
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img my-mw-100"
                                                                                    src="{{ $setting->qr ? asset('assets/images/'.$setting->qr) : asset('assets/images/placeholder.png') }}"
                                                                                    alt="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 16 x 16.') }}</span>
                                                                        </div>
