    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class=" mb-0 bc-title"><b>{{ __('Create Banner') }}</b> </h3>
                            ...
                            <ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
                              ...
                              <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <form  action="{{ route('back.banner.store') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            <label id="banner_text"  for="name">{{ __('Set banner Image') }} *</label>
                                            <br>
                                                <img class="admin-img" src="{{  asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                ...
                                <div class="tab-pane fade" id="pills-home4" role="tabpanel" aria-labelledby="pills-home4-tab"><form  action="{{ route('back.banner.store') }}" method="POST"
                                    enctype="multipart/form-data">
