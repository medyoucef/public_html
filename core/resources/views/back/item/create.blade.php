                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea name="sort_details" id="sort_details"
                           ...
                           required  >{{ old('sort_details') }}</textarea>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select required  name="category_id" id="category_id" data-href="{{route('back.get.subcategory')}}" class="form-control" >
                    ...
                    <div class="form-group d-none">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" id="stock"
                                ...
                                placeholder="{{ __('Total in stock') }}" value="99" >
                        </div>
                    </div>
                    <div class="form-group d-none">
